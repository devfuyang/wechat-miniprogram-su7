Page({
  ...
  handleConfirm() {
    ...
    const isVersionValid = selectedVersion!== '';
    const isColorValid = selectedColor!== '';
    const isInteriorValid = selectedInterior!== '';
    const isWheelsValid = selectedWheels!== '';
    ...
    if (
      ...
      wx.request({
        url: this.data.url + 'api/addmishu',
        method: 'POST',
        data: data,
        header: {
